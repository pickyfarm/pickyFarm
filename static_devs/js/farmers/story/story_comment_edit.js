...
const storyCommentEdit = (targetComment, pk) => {
    ...
    document
        ...
        .addEventListener('submit', (e) => {
            e.preventDefault();
            storyCommentEditSubmit(pk);
        });
};

const storyCommentEditSubmit = (pk) => {
    const text = document.querySelector('.comment-edit-form-input').value;

    $.ajax({
        type: 'POST',
        url: `../../../../comment/farmer_story/${storyPK}/comment/edit/${pk}/`,
        dataType: 'json',
        data: {
            text: text,
...
const storyRecommentEdit = (targetComment, pk) => {
    ...
    document
        ...
        .addEventListener('submit', (e) => {
            e.preventDefault();
            storyRecommentEditSubmit(pk);
        });
};

const storyRecommentEditSubmit = (pk) => {
