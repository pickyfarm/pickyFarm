...
def kakao_callback(request):
    ...
    try:
        ...
        phone_number = profile.get("phone_number", "10-0000-0000")
        print(email)
        try:
    ...
    if request.method == "GET":
        ...
        if cat_name == "orders":
            ...
            ctx_orders = {
                ...
                "order_details_exist": len(order_details) if order_details else 0,
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            try:
                ...
                if form.cleaned_data.get("account_name") == username:
                    ctx = {"user": user}
...
class ProductCommentCreate(TemplateView):
    ...
    def post(self, request, **kwargs):
        ...
        if product_comment.is_valid() and not product_comment_eixst:
            ...
            detail.product.product_group.calculate_total_rating_avg()
